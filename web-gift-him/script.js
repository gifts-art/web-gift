/* WebGift Him — Masculine palette in canvas FX */

(function () {
  'use strict';

  const BRAND_COLORS = ['#1C69D4', '#4DA3E0', '#0066B1', '#C0C4C8', '#FFFFFF'];
  const BRAND_RGBA = [
    'rgba(28,105,212,',
    'rgba(77,163,224,',
    'rgba(0,102,177,',
  ...
  function initAmbient() {
    ...
    function draw() {
      ...
      if (!isMobile && ambientParticles.length > 10) {
        ambientCtx.strokeStyle = 'rgba(28, 105, 212, 0.06)';
  ...
  const confettiColors = BRAND_COLORS;
  ...
  function initCatchGame() {
    ...
    startBtn?.addEventListener('click', () => {
      ...
      catchSpawnTimer = setInterval(spawnHeart, 500);
      gameLoop();
